...
srun $HOME/angsd/angsd -P 24 -yBin $HOME/ds-lh/phenos/sub.phenos -r $HOME/ds-lh/genome/smelt-genome.fasta -minMapQ 30 -minQ 20 -minInd 27 -doAsso 1 -GL 1 -out $HOME/ds-lh/outputs/100/sub -doMajorMinor 1 -doMaf 1 -SNP_pval 1e-6 -bam $HOME/ds-lh/bamlist/sub.bamlist 
