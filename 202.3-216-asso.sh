...
srun $HOME/angsd/angsd -P 24  -bam $HOME/ds-lh/bamlists/216.bamlist -yBin $HOME/ds-lh/phenos/216.phenos -minMapQ 30 -minQ 20 -minInd 196 -doAsso 1 -GL 1 \
-out $HOME/ds-lh/outputs/200/216 -doMajorMinor 1 -doMaf 1 -SNP_pval 1e-6 \
