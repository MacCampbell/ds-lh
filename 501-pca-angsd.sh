...
srun $HOME/angsd/angsd -minInd 194 -GL 1 -out $HOME/ds-lh/outputs/500/216-pca -nThreads 12 -doGlf 2 -doMajorMinor 1 -doMaf 2 -SNP_pval 1e-6 -minMapQ 30 -minQ 20 \
-bam $HOME/ds-lh/bamlists/216.bamlist

# Generate a covariance matrix
# For Linux
srun python $HOME/pcangsd/pcangsd.py -beagle $HOME/outputs/500/216-pca.beagle.gz -admix -o $HOME/ds-lh/outputs/500/216-pca
