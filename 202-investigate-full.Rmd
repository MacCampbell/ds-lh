...
It seems to me that there may be some extremes in the data.  I'm curious how fish plot on a PCA coloring on migratory phenotype. There also exists some ways to 
