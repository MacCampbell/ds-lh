...
Runing 202.2-make-vch.sh on cluster. Seg fault again. Switching to making text plink files to convert to .vcf. We can recode and prune linked SNPs like so:

```{sh, eval=FALSE}
#in outputs/200
plink --tped partial-vcf.tped --tfam partial-vcf.tfam  --out binary --recode --allow-extra-chr --noweb
